...
class AT_Navigation
{
    ...
    */
    ...
    public function config_loaded(&$settings)
    {
        ...
        // default excludes
        $this->settings['at_navigation']['exclude'] = array_merge_recursive(array(
            'single' => array(),
            'folder' => array()
    ...
    private function at_build_navigation($navigation = array(), $start = false)
    {
        ...
        if (isset($navigation['_child'])) {
            ...
            usort($_child, function(array $a, array $b)
            {
    ...
    private function at_recursive($split = array(), $page = array(), $current_page = array())
    {
        if (count($split) == 1) {
            ...
            return array(
                '_child' => array(
                    $first => $this->at_recursive($split, $page, $current_page)
                )
            );
        }
    }
